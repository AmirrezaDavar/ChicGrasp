...
DEFAULT_OBS_KEY_MAP = {
    ...
    # gripper
    'LeftJawState': 'left_jaw',
    'RightJawState': 'right_jaw',
    # timestamps
    'step_idx': 'step_idx',
    'timestamp': 'timestamp'
}
...
class RealEnv:
    ...
    def get_obs(self) -> dict:
        ...
        # print(f'######################robot_obs_raw######################', robot_obs_raw) 
        # so by printing robot_obs_raw it became clear that gripper data are there :)
        
        robot_obs = dict()
        for k, v in robot_obs_raw.items():
            robot_obs[k] = v[this_idxs]
        # print(f'##########################robot_obs##########################',robot_obs)
        # so by printing robot_obs it became clear that gripper data are there :)
        ...
        # print(f'##############obs_accumulator###############', self.obs_accumulator)
        # the result for this is None
    ...
    # the gripper data should be added here ##########
    def exec_actions(self, 
        ...
        # Assuming action_accumulator has actions and timestamps attributes
        # print("######## action accumulator actions ########", self.action_accumulator)
        

        # Record stages if stage accumulator is active
