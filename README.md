...
[Paper](https://doi.org/10.1002/adrr.202500149) · [Project portfolio](https://AmirrezaDavar.github.io/ChicGrasp/) · [Data and checkpoints](https://uark.box.com/s/c9bnzfpy6shej765x8g0z3fzt3q8ay7p) · [Project video — being finalized](https://AmirrezaDavar.github.io/ChicGrasp/#overview)
...
[![All 142 archived diffusion-policy recordings](docs/assets/evaluations/dp_all_142_grid_web.jpg)](https://AmirrezaDavar.github.io/ChicGrasp/evaluations.html)

[Watch the tiled evaluation video](https://AmirrezaDavar.github.io/ChicGrasp/#evaluations) · [Browse all 142 episodes](https://AmirrezaDavar.github.io/ChicGrasp/evaluations.html) · [23 individual action videos](https://AmirrezaDavar.github.io/ChicGrasp/action-videos.html)

The grid contains all available DP archive episodes, shown together at 4× speed. The recordings cover the grasp phase and end before lift and scripted rehang; they have not been mapped to the paper’s 140 labeled trials.

The finalized 80-second overview will be added to the [video placeholder](https://AmirrezaDavar.github.io/ChicGrasp/#overview). See the [portfolio editing guide](docs/PORTFOLIO.md) to add videos, figures, or evaluation material.
...
A separate replay at the checkpoint's original 100-iteration setting shows normalized XYZ with fixed axes and raw jaw values. [Interactive explorer](https://AmirrezaDavar.github.io/ChicGrasp/policy.html#actions) · [Figure PDF](docs/assets/figures/diffusion_denoising.pdf) · [Final action sequence in physical units](docs/assets/figures/final_action_sequence.pdf).
